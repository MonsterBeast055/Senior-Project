/*
 * sample.ts - Real engine output, for running the UI without a backend.
 *
 * The function at 0x140002418 is NOT invented. It is the actual CFG the C++
 * engine produced for C:\\Windows\\System32\\notepad.exe: 20 blocks, 34 edges,
 * 106 instructions, every one as Capstone decoded it. It is the MSVC CRT's
 * __isa_available_init - the "GenuineIntel" vendor check is visible in the xor
 * constants at 0x140002436.
 *
 * Real output was used deliberately. A mock built from imagination would have
 * let the UI quietly assume things the engine does not actually provide.
 *
 * sub_1400023a0 is synthetic, because the sample needed one function that has
 * resolved API calls, referenced strings, a reachable finding and lifted C, in
 * order to exercise those paths.
 */
import type {
    BasicBlock, FindingsDocument, ExtractedString, FunctionDetail,
    FunctionSummary, ImageInfo, Instruction, LiftedFunction, Successor, FlowKind, Hex,
} from "./types";

export const sampleImage: ImageInfo = {
    schema_version: "1.0",
    format: "pe",
    arch: "x86_64",
...
export const sampleFunctions: FunctionSummary[] = [
    { va: "0x140002418", name: "sub_140002418", block_count: 20, instruction_count: 106,
      ...
      is_thunk: false, confidence: "certain", content_hash: "0xaaaaaaaaaaaaaaaa" },
    { va: "0x1400023a0", name: "sub_1400023a0", block_count: 9, instruction_count: 61,
      ...
      is_thunk: false, confidence: "certain", content_hash: "0x22eece1ddc5e0f" },
    { va: "0x1400019c0", name: "sub_1400019c0", block_count: 1, instruction_count: 4,
      ...
      is_thunk: false, confidence: "certain", content_hash: "0xb390f6c6b4" },
    { va: "0x14000da7c", name: "sub_14000da7c", block_count: 161, instruction_count: 778,
      ...
      is_thunk: false, confidence: "certain", content_hash: "0x5036f6bd30b" },
    { va: "0x140013154", name: "sub_140013154", block_count: 1620, instruction_count: 11304,
      ...
      is_thunk: false, confidence: "certain", content_hash: "0x14848c2845" },
    { va: "0x140001094", name: "sub_140001094", block_count: 10, instruction_count: 67,
      ...
      is_thunk: false, confidence: "certain", content_hash: "0x106fe8b3a" },
    { va: "0x140001040", name: "CreateFileW_thunk", block_count: 1, instruction_count: 1,
      ...
      is_thunk: true, is_imported_stub: true, confidence: "high", content_hash: "0x1" }
];

function ins(
    va: Hex, size: number, mnemonic: string, operands?: string,
    flow?: FlowKind, target?: Hex | null, target_name?: string | null,
): Instruction {
    return {
        va, size, mnemonic, operands: operands ?? "",
...
function blk(
    start: Hex, end: Hex, instructions: Instruction[],
    successors: Successor[], unresolved?: boolean,
): BasicBlock {
    return {
        start, end, instruction_count: instructions.length,
        has_unresolved_exit: !!unresolved,
        instructions, successors, predecessors: [],
    };
}

const T = (t: Hex): Successor => ({ target: t, kind: "taken", confidence: "high" });
const F = (t: Hex): Successor => ({ target: t, kind: "fall-through", confidence: "high" });
const J = (t: Hex): Successor => ({ target: t, kind: "jump", confidence: "high" });

const detail_140002418: FunctionDetail = {
    va: "0x140002418",
    name: "sub_140002418",
    extent_end: "0x1400025c4",
    convention: "win64",
    is_thunk: false, is_imported_stub: false, returns: true, is_library_code: false,
    // 20 blocks / 34 edges, matching the engine's real output for this function.
    block_count: 20,
    instruction_count: 106, indirect_call_count: 0,
    content_hash: "0xaaaaaaaaaaaaaaaa",
...
const detail_1400023a0: FunctionDetail = {
    ...
    content_hash: "0x22eece1ddc5e0f", cyclomatic_complexity: 7, information_score: 74,
    confidence: "certain",
...
export const sampleFindings: FindingsDocument = {
    schema_version: "1.0",
    methodology: {
...
export const sampleStrings: ExtractedString[] = [
...
export const sampleLifted: Record<string, LiftedFunction> = {
    "0x1400023a0": {
        model: "sample",
...
export const sampleDetails: Record<string, FunctionDetail> = {
